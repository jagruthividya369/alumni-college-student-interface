...
<%	String userid=(String)session.getAttribute("aluid");
    ...
    ResultSet rs;
    rs = st.executeQuery("select ename,etype,branch,date1,des from event where userid='" + userid + "'");
    out.print("<thead>"+
    	    "<tr>"+
    ...
    while(rs.next())
    {
	out.print("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td><input type='submit' name='de' value="+rs.getString(1)+"></td></tr>");
    }
    out.print("</tbody>");
